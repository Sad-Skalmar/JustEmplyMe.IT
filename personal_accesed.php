...
<div id = "slider">
        ...
        <div id="container">
        <div id = "account">
            <button id = "show_account_list" onclick = "show_account_list()">Sign in <i class="fa-solid fa-arrow-down"></i></button>
            <button id = "hide_account_list" onclick = "hide_account_list()">Sign in <i class="fa-solid fa-arrow-up"></i></button>
                <ul id = "account_list">
                            <a href = 'sign_in.php'><li class = "list_element">Sign in</li></a>
                            <a href = 'register.php'><li class = "list_element">Register</li></a>
                            <!--<a href = ''><li class = "list_element">My Account</li></a>
                            <a href = ''><li class = "list_element">My Job Offers</li></a>
                            <a href = ''><li class = "list_element">Log Off</li></a>-->

                </ul>
        </div>
        <div id = "sort_by">
            <button id = "show_sort_list" onclick = "show_sort_list()">Sort <i class="fa-solid fa-arrow-down"></i></button>
            <button id = "hide_sort_list" onclick = "hide_sort_list()">Sort <i class="fa-solid fa-arrow-up"></i></button>
                <ul id = "sort_list">
