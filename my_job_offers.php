                ...
                if ($queryApplicantInfo->num_rows < 1) {
                    ...
                    while ($queryApplicantInfo->fetch()) {
                        ...
                        <div class="application">
                            <div class="applicationDate">Application date: <br>' . htmlspecialchars($applicationDate, ENT_QUOTES, 'UTF-8') . '</div>
                            <div class="applicationName">Applicant Name: <a href="profile.php?id=' . htmlspecialchars($applicantId, ENT_QUOTES, 'UTF-8') . '" target="_blank"><br>' . htmlspecialchars($applicantName, ENT_QUOTES, 'UTF-8') . '</a></div>
                            <div class="applicationCV"><a target="_blank" href="Konrad Hościło - CV PL.pdf"?forcedownload=1>Download Applicant Resume</a></div>
                            <div class="applicationStatusChange">Status: <p id="statusText_' . htmlspecialchars($applicationId, ENT_QUOTES, 'UTF-8') . '" class="statusText">' . htmlspecialchars($status, ENT_QUOTES, 'UTF-8') . '</p></div>
                        </div>';
                    }
                }
